    ...
    return BlocProvider(
      ...
      child: BlocConsumer<AppCubit,AppStates>(
        listener: ((BuildContext context , AppStates state){
          ...
          if (state is ParentCreateSuccessState)
          {
            CacheHelper.saveData(
              ...
              state: ToastStates.SUCCESS);
                navigateAndFinis(context, ParentHomeLayout());
              });
          }
          //else if(state is ParentCreateErrorState)
          //   {
          //     showToast(
          //       text: state.error,
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    ConditionalBuilder(
                      condition: state is ! ParentRegisterLoadingState,
